...
GUIDE = page_guide("Bracket Simulator", [
    ("🎲", "Monte Carlo runs 10,000 tournament simulations using live Elo ratings — results are probabilistic, not fixed."),
    ("🔥", "Championship Heatmap: colour intensity = probability a team wins the tournament. Darker = more likely."),
    ("🌊", "Sankey diagram shows how teams flow through rounds — thicker bands = more simulation paths."),
    ("🏆", "Path to Glory: pick any team and see their most likely route to the final."),
    ("🔄", "Run simulation again to see natural variance — Elo gives probabilities, not certainties."),
